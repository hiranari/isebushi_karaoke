...
class KaraokePageLegacy extends StatefulWidget {
  const KaraokePageLegacy({super.key});
  @override
  State<KaraokePageLegacy> createState() => _KaraokePageLegacyState();
}

class _KaraokePageLegacyState extends State<KaraokePageLegacy> {
